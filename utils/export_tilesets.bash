...
# Example: ls *.aseprite -1 | xargs -n1 ./export_tilesets.bash
...
aseprite -b --export-tileset "$stripped" --ignore-layer Background --sheet-type rows --sheet-columns 8 --sheet "$noext".png --data dump.json
