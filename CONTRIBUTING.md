...
Code you write should contain the least amount of comments possible. Code should be self-documenting, to avoid writing additional documentation. Contributors should use exepressive variable names that fit the style of the existing codebase. Use Astyle with the following input:
