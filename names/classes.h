...
REGISTER_ENUM(MAGE,         20, MAGES,        SKILLED_MAGE,
              ITEM_TYPE_ELEMENTAL + ITEM_TYPE_ANGELIC + ITEM_TYPE_SHIELD)
...
REGISTER_ENUM(KEWAC_RUNNER,     30, MAGES,      START,        ITEM_TYPE_LANCE + ITEM_TYPE_SHIELD)
REGISTER_ENUM(KEWAC_HUNTER,     32, MAGES,      START,        ITEM_TYPE_LANCE + ITEM_TYPE_SHIELD)
REGISTER_ENUM(KEWAC_WARRIOR,    33, MAGES,      START,        ITEM_TYPE_LANCE + ITEM_TYPE_SHIELD)
REGISTER_ENUM(WOLFSPEAKER,      34, MAGES,      START,        ITEM_TYPE_STAFF + ITEM_TYPE_SHIELD)
...
REGISTER_ENUM(LEGIONARY,      52, FOOT_SLOW,    SKILLED_RIDER,  ITEM_TYPE_LANCE + ITEM_TYPE_SHIELD)
REGISTER_ENUM(GLADIATOR,      53, FOOT_SLOW,    START,
              ITEM_TYPE_SWORD + ITEM_TYPE_LANCE + ITEM_TYPE_SHIELD)
REGISTER_ENUM(TETRABRACHIOS,  54, FOOT_SLOW,    START,
              ITEM_TYPE_SWORD + ITEM_TYPE_LANCE + ITEM_TYPE_SHIELD)
