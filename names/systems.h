...
REGISTER_ENUM(Animate_Cutscene,        TNECS_PIPELINE_RENDER, 0, 0, Cutscene_ID, Position_ID,
              Text_ID, Timer_ID);
...
REGISTER_ENUM(Slide_Sprite,            TNECS_PIPELINE_RENDER, 0, 0, Sprite_ID,   Position_ID,
              Slider_ID);
REGISTER_ENUM(Slide_Actor,             TNECS_PIPELINE_RENDER, 0, 0, Actor_ID,    Position_ID,
              Slider_ID);
REGISTER_ENUM(Slide_PopUp_Offscreen,   TNECS_PIPELINE_RENDER, 0, 0, PopUp_ID,    Slider_ID,
              SliderOffscreen_ID,
              Position_ID);
...
REGISTER_ENUM(Draw_Sprite,             TNECS_PIPELINE_RENDER, 0, 0, Unit_ID, Position_ID, Sprite_ID,
              MapHPBar_ID);
REGISTER_ENUM(Draw_Sprite,             TNECS_PIPELINE_RENDER, 0, 0, Unit_ID, Position_ID,
              Sprite_ID);
REGISTER_ENUM(Draw_Sprite,             TNECS_PIPELINE_RENDER, 0, 0, Unit_ID, Position_ID, Sprite_ID,
              RenderTop_ID);
REGISTER_ENUM(Draw_Actor,              TNECS_PIPELINE_RENDER, 0, 0, Actor_ID, Position_ID,
              Slider_ID);
...
REGISTER_ENUM(Draw_Text,               TNECS_PIPELINE_RENDER, 0, 0, Text_ID, Position_ID);
...
REGISTER_ENUM(Draw_Sprite,             TNECS_PIPELINE_RENDER, 0, 0, controllerMouse_ID,
              Position_ID, Sprite_ID, MouseFlag_ID);

REGISTER_ENUM(Animate_Combat_onMap,    TNECS_PIPELINE_RENDER, 0, 0, CombatAnimation_ID,   Timer_ID);
REGISTER_ENUM(Animate_Map_Animation,   TNECS_PIPELINE_RENDER, 0, 0, MapAnimation_ID,
