...
REGISTER_ENUM(Draw_Sprite,              0, 1, Unit_ID, Position_ID, Sprite_ID, MapHPBar_ID, AI_ID,
              Boss_ID);
REGISTER_ENUM(Draw_Sprite,              0, 1, Unit_ID, Position_ID, Sprite_ID, Timer_ID,
              MapHPBar_ID, AI_ID, UnitMoveAnimation_ID);
REGISTER_ENUM(Draw_Sprite,              0, 1, Unit_ID, Position_ID, Sprite_ID, Timer_ID,
              MapHPBar_ID, AI_ID, UnitMoveAnimation_ID, Boss_ID);
...
REGISTER_ENUM(Draw_Actor,               0, 1, Actor_ID, Position_ID, Slider_ID);
...
REGISTER_ENUM(Draw_Sprite,              0, 1, controllerMouse_ID,   Position_ID, Sprite_ID,
              MouseFlag_ID);
