...
/* -- Loading -- */
void Tilemap_Shader_Load_JSON(          struct Tilemap_Shader *s,
                                        const cJSON *jm, const cJSON *st);
void Tilemap_Shader_Load_Tileset_JSON(  struct Tilemap_Shader *s,
                                        const cJSON *st);
void Tilemap_Shader_Load_Tilemap_JSON(  struct Tilemap_Shader *s,
                                        const cJSON *jmap);
void Tilemap_Shader_Load_Tileset_pixels(struct Tilemap_Shader *s,
                                        char *f,
                                        size_t tnum, i32 tilesize[TWO_D]);

/* -- Shading -- */
SDL_Surface *Tilemap_Shade_Surface(struct Tilemap_Shader *ts,
                                   SDL_Surface *su,
...
/* -- Loading -- */
void Index_Shader_Load( struct Index_Shader *is,
                        SDL_Surface *s, SDL_Rect *r);

/* -- Shading -- */
SDL_Surface *Index_Shade_Surface(struct Index_Shader *is,
                                 SDL_Surface *s, SDL_Rect *r);
