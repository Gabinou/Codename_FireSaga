...
enum SOTA_TEXT {
    SOTA_TEXT_LEFT_ALIGNED   = 0,
    SOTA_TEXT_CENTERING      = 1,
    SOTA_TEXT_RIGHT_ALIGNED  = 2,
...
#include "names/weapon_stats.h"
    WEAPON_STAT_END,
    WEAPON_STAT1H_END = WEAPON_STAT_MASTERY,
    ITEM_STAT_INVALID   = 0,
    WEAPON_STAT_INVALID = 0,
};
#undef REGISTER_ENUM
