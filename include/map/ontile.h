...
void  Map_Unit_Remove(     struct Map *map, tnecs_world *w, tnecs_entity entity);
...
/* --- Map Objects --- */
void Map_Door_onOpen(       struct Map *map, tnecs_world *w, tnecs_entity d);
void Map_Chest_onOpen(      struct Map *map, tnecs_world *w, tnecs_entity c);
void Map_Breakable_onBroken(struct Map *map, tnecs_world *w, tnecs_entity b);
