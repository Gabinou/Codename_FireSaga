...
#define PATH_JOIN_(N, ...) SOTA_CONCAT(PATH_JOIN_FOREACH_, N)(__VA_ARGS__)
...
/* --- SURFACES&TEXTURES --- */
SDL_Surface *Filesystem_TexturetoSurface(SDL_Renderer *, SDL_Texture *,
                                         u32, SDL_Texture *);
void Filesystem_Texture_Dump(   char *f, SDL_Renderer *,
                                SDL_Texture *, u32 fo,
                                SDL_Texture *rt);
...
SDL_Texture *Filesystem_Texture_Load(SDL_Renderer *, char *f, u32);

/* -- Palettes & index shaders -- */
SDL_Surface *Filesystem_indexedSurface_Init(size_t w, size_t h);
SDL_Surface *Filesystem_Surface_Palette_Swap(   SDL_Surface *s,
                                                SDL_Palette *p);
void Filesystem_Surface_Pixels2Indices( SDL_Surface *r,
                                        SDL_Surface *i);
