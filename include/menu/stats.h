...
enum STATS_MENU_COLOR {
    STATS_MENU_HPBAR_BD   = 13,
    STATS_MENU_HPBAR_BL   = 14,
    STATS_MENU_HPBAR_FD   = 52,
    STATS_MENU_HPBAR_FL   = 54,

    STATS_MENU_STATBAR_BD = 29,
    STATS_MENU_STATBAR_BL = 26,
    STATS_MENU_STATBAR_FD = 52,
    STATS_MENU_STATBAR_FL = 54,
