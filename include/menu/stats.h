...
extern void StatsMenu_Draw_Name(         struct StatsMenu *sm, SDL_Renderer *r);
extern void StatsMenu_Draw_Mount(        struct StatsMenu *sm, SDL_Renderer *r);
extern void StatsMenu_Draw_Stats(        struct StatsMenu *sm, SDL_Renderer *r);
extern void StatsMenu_Draw_Hands(        struct StatsMenu *sm, SDL_Renderer *r);
extern void StatsMenu_Draw_Rescue(       struct StatsMenu *sm, SDL_Renderer *r);
extern void StatsMenu_Draw_Skills(       struct StatsMenu *sm, SDL_Renderer *r);
extern void StatsMenu_Draw_Statuses(     struct StatsMenu *sm, SDL_Renderer *r);
extern void StatsMenu_Draw_WpnTypes(     struct StatsMenu *sm, SDL_Renderer *r);
extern void StatsMenu_Draw_Equipment(    struct StatsMenu *sm, SDL_Renderer *r);
extern void StatsMenu_Draw_ComputedStats(struct StatsMenu *sm, SDL_Renderer *r);
