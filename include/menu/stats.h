...
enum STATS_MENU {
    ...
    ATK_Y_OFFSET_STAT1  = ATK_Y_OFFSET + STATS_MENU_LINESPACE + 1,
    ...
    STATBAR_COL1_Y_OFFSET  =  2,
    STATBAR_COL2_X_OFFSET  = 22,
    STATBAR_COL2_Y_OFFSET  =  2,
    HPBAR_X_OFFSET         = 39,
    HPBAR_Y_OFFSET         =  1,
...
enum STATS_MENU_COLOR {
    STATS_MENU_HPBAR_BD     = 33,
    STATS_MENU_HPBAR_BL     = 34,
    STATS_MENU_HPBAR_FD     =  3,
    STATS_MENU_HPBAR_FL     =  4,
    STATS_MENU_HPBAR_EMPTY  =  1,

    STATS_MENU_STATBAR_BD = 17,
    STATS_MENU_STATBAR_BL = 18,
    STATS_MENU_STATBAR_FD = 3,
    STATS_MENU_STATBAR_FL = 4,
};
