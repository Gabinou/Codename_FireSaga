...
extern const Spritesheet Spritesheet_default;

/* --- Constructor/Destructors --- */
void Spritesheet_Free(Spritesheet *ss);

/* --- Animation --- */
void Spritesheet_Loop_Set(  Spritesheet *ss, int l,
                            SDL_RendererFlip f);
...
typedef struct Sprite {
    ...
    */
    ...
    SDL_Rect srcrect;
    SDL_Rect dstrect;
    SDL_Rect srcrect_shadow; /* where sprite gets shaded */
    u16 tilesize[TWO_D];
    ...
    /* Each sprite can have ONE spritesheets ->
    **  one timer per entity */
...
extern const Sprite Sprite_default;

/* --- dstrect_funcs array --- */
typedef void (*dstrect_func_t)(Sprite *, struct Point *, struct Camera *);
...
/* --- Initialization --- */
void Sprite_Load(           Sprite *s, char *n, SDL_Renderer *r);
void Sprite_Tilesize_Set(   Sprite *s, u16 *t);
void Sprite_Map_Unit_Load(  Sprite *s, struct Unit *u, SDL_Renderer *r);
void Sprite_defaultShaders_Load(Sprite *s);

/* -- rect computation -- */
void Cursor_Rects_Init(      Sprite *s);
void Sprite_Rects_Init(      Sprite *s);
void Cursor_Dstrect_Relative(Sprite *s, struct Point *, struct Camera *);
void Cursor_Dstrect_Absolute(Sprite *s, struct Point *, struct Camera *);
void Sprite_Dstrect_Relative(Sprite *s, struct Point *, struct Camera *);
void Sprite_Dstrect_Absolute(Sprite *s, struct Point *, struct Camera *);

/* --- Shading --- */
void Sprite_Shade(       Sprite *s, SDL_Renderer *r, struct Index_Shader *is);
...
void Sprite_Animation_Loop(   Sprite *s);
void Sprite_Animation_Restart(Sprite *s, int loop);
