...
I was happy not to have to do all this work myself at first, but after I while I grew dissatisfied.
...
```
astyle --style=java --indent=spaces=4 --indent-switches --pad-oper --pad-comma --pad-header --unpad-paren  --align-pointer=middle --align-reference=middle --add-braces --add-one-line-braces --attach-return-type --convert-tabs --suffix=none include/*.h src/*.c test/*.h test/*.c
``` 
