...
void baseBooks() {
    ...
    page.paragraphs.push_back("In serving your King properly, there cones a tine where a Knight may be required to march out and fight battles in the field. This handbook intends to properly guide even the most lowly of squires into capable knights. ");
    book.addPage(page);
    ...
    page.paragraphs.clear();
    page.title = "Randomness is hard for the peasant ";
    ...
    page.paragraphs.push_back("In truth, peasants are rather mediocre at judging chance. We all tend to overestimate high chance events and underestimate low chance events.");
