...
void makeunitNames() {
    ...
    unitNames.push_back("Lauzon");
    unitNames.push_back("Nicole");
    unitNames.push_back("Otto");
    unitNames.push_back("Sebastian");
    unitNames.push_back("Michael");
    unitNames.push_back("Chasse");
    unitNames.push_back("Pierre");
    unitNames.push_back("Melly");
    unitNames.push_back("Simon");
    unitNames.push_back("Rayan");
    unitNames.push_back("Teharon");
    unitNames.push_back("Tekak");
    unitNames.push_back("Eugene");
    unitNames.push_back("Lucrece");
    unitNames.push_back("");
    unitNames.push_back("Zinedan");
    unitNames.push_back("Zidine");
    unitNames.push_back("Sawisk");
