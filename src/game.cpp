...
void Game::baseWeapons(){
    ...
    temp_wpn = {3, 80, 0, 0, 0, 3, 30, 2, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {1, 50, 0, 0, 0, 2, 10, 1, {1,1}, {1}, 0};
    ...
    temp_wpn = {7, 70, 0, 25, 0, 7, 30, 9, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {4, 90, 0, 0, 0, 4, 20, 6, {1,1}, {1}, 0};
    ...
    temp_wpn = {8, 85, 5, 0, 0, 5, 25, 8, {1,1}, {1}, 0};
    ...
    temp_wpn = {9, 60, 0, 0, 0, 9, 30, 10, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {13, 65, 0, 0, 0, 10, 25, 12, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {4, 70, 0, 0, 10, 6, 30, 9, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {10, 40, 0, 0, 0, 10, 25, 6, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {9, 60, 10, 5, 0, 8, 25, 10, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {7, 75, 5, 0, 0, 5, 30, 8, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {1, 50, 0, 0, 0, 1, 20, 10, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {14, 90, 10, 0, 0, 7, 25, 14, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {16, 100, 0, 0, 10, 9, 20, 12, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {15, 90, 10, 0, 0, 10, 30, 15, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {12, 100, 0, 0, 0, 6, 20, 18, {1,1}, {1}, 0};
    ...
    temp_wpn = {5, 50, 0, 0, 0, 7, 25, 11, {1,2}, {1,2}, 1};
    ...
    temp_wpn = {7, 45, 0, 0, 0, 1, 25, 11, {1,2}, {1,2}, 1};
    ...
    temp_wpn = {16, 60, 5, 5, 0, 7, 35, 18, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {20, 30, 0, 0, 0, 20, 50, 20, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {2, 60, 0, 0, 0, 4, 15, 1, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {3, 70, 0, 0, 0, 3, 30, 5, {1,1}, {2}, 0};
    ...
    temp_wpn = {5, 95, 0, 0, 0, 5, 40, 4, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {7, 80, 30, 0, 0, 3, 30, 9, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {12, 85, 0, 0, 0, 12, 25, 13, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {6, 60, 0, 0, 0, 15, 10, 8, {1,1}, {1,2}, 0};
    ...
    all_weapons["Vel"] = Vel;
    temp_wpn = {8, 90, 0, 0, 0, 6, 20, 9, {1,2}, {1,2}, 1};
    ...
    temp_wpn = {12, 70, 0, 0, 0, 10, 32, 18, {1,2}, {1,2}, 0};
    ...
    temp_wpn = {16, 50, 0, 0, 0, 14, 24, 17, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {8, 40, 0, 0, 0, 8, 40, 4, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {14, 55, 0, 0, 0, 13, 25, 11, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {14, 65, 20, 0, 0, 11, 30, 10, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {6, 30, 0, 0, 0, 7, 25, 5, {1,2}, {1,2}, 0};
    ...
    temp_wpn = {10, 40, 0, 0, 0, 7, 25, 10, {1,2}, {1,2}, 0};
    ...
    temp_wpn = {7, 60, 0, 0, 0, 9, 20, 3, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {10, 50, 0, 0, 0, 11, 20, 12, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {8, 40, 0, 0, 0, 9, 30, 8, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {12, 50, 0, 0, 0, 12, 25, 11, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {12, 70, 0, 0, 0, 14, 35, 9, {1,1}, {1}, 0};
    ...
    temp_wpn = {8, 60, 0, 0, 0, 18, 28, 14, {1,1}, {1}, 0};
    ...
    temp_wpn = {10, 85, 0, 0, 0, 12, 15, 7, {1,1}, {1}, 0};
    ...
    temp_wpn = {7, 80, 0, 0, 0, 5, 30, 10, {1,1}, {1}, 0};
    ...
    temp_wpn = {18, 50, 0, 0, 0, 19, 20, 11, {1,1}, {1}, 0};
    ...
    temp_wpn = {13, 75, 0, 0, 0, 10, 24, 14, {1,1}, {1}, 0};
    ...
    temp_wpn = {19, 69, 0, 0, 0, 9, 25, 17, {1,1}, {1}, 0};
    ...
    temp_wpn = {18, 96, 0, 0, 0, 4, 26, 19, {1,1}, {1}, 0};
    ...
    temp_wpn = {1, 0, 5, 0, 1, 2, 15, 2, {1,1}, {1}, 0};
    ...
    temp_wpn = {2, 0, 8, 0, 0, 3, 20, 7, {1,1}, {1}, 0};
    ...
    temp_wpn = {4, 0, 10, 0, 4, 5, 0, 13, {1,1}, {1}, 0};
    ...
    temp_wpn = {3, 0, 9, 0, 2, 4, 25, 9, {1,1}, {1}, 0};
    ...
    temp_wpn = {8, 0, 15, 0, 4, 4, 35, 12, {1,1}, {1}, 0};
    ...
    temp_wpn = {6, 0, 6, 0, 6, 6, 36, 6, {1,1}, {1}, 0};
    ...
    temp_wpn = {7, 0, 7, 0, 7, 7, 37, 7, {1,1}, {1}, 0};
    ...
    temp_wpn = {5, 0, 5, 0, 5, 9, 30, 10, {1,1}, {1}, 0};
    ...
    temp_wpn = {11, 0, 15, 0, 5, 13, 25, 7, {1,1}, {1}, 0};
    ...
    temp_wpn = {12, 0, 20, 0, 10, 10, 0, 14, {1,1}, {1}, 0};
    ...
    temp_wpn = {9, 0, 5, 0, 200, 9, 22, 13, {1,1}, {1}, 0};
    ...
    temp_wpn = {15, 0, 10, 0, 2, 13, 19, 12, {1,1}, {1}, 0};
    ...
    temp_wpn = {4, 8, 0, 14, 0, 7, 16, 19, {1,1}, {1}, 0};
    ...
    temp_wpn = {1, 0, 10, 0, 5, 4, 35, 7, {1,1}, {1}, 0};
    ...
    temp_wpn = {2, 0, 22, 0, 4, 6, 28, 12, {1,1}, {1}, 0};
    ...
    temp_wpn = {3, 14, 0, 8, 0, 4, 20, 10, {1,1}, {1}, 0};
    ...
    temp_wpn = {3, 5, 0, 0, 0, 2, 26, 8, {1,1}, {1}, 0};
    ...
    temp_wpn = {5, 8, 0, 0, 0, 4, 24, 11, {1,1}, {1}, 0};
    ...
    all_weapons["kodachi"] = kodachi;
        temp_wpn = {4, 10, 0, 0, 0, 3, 20, 10, {1,1}, {1}, 0};
    ...
    temp_wpn = {7, 0, 0, 0, 0, 8, 10, 15, {1,1}, {1}, 0};
    ...
    temp_wpn = {0, 0, 0, 0, 0, 7, 30, 10, {1,1}, {1}, 0};
    ...
    temp_wpn = {8, 10, 10, 0, 2, 9, 24, 17, {1,1}, {1}, 0};
    ...
    temp_wpn = {7, 0, 0, 0, 0, 7, 8, 5, {1,1}, {1}, 0};
