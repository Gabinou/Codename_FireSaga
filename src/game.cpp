...
void Game::setState(Entity & setting_entity, std::string new_state) {
    ...
    if (this->state == "map") {
        ...
        if (new_state == "unitmove") {
            ...
            movemap(mapp, start, unit_move, "list");
...
void Game::baseWeapons(){
    ...
    temp_wpn = {3, 70, 0, 0, 0, 3, 30, {1,1}, {2}, 0};
    ...
    temp_wpn = {8, 90, 0, 0, 0, 6, 10, {1,2}, {1,2}, 1};
    ...
    temp_wpn = {12, 70, 0, 0, 0, 10, 10, {1,2}, {1,2}, 0};
    ...
    temp_wpn = {11, 50, 0, 0, 0, 10, 35, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {14, 55, 0, 0, 0, 13, 25, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {10, 40, 0, 0, 0, 7, 25, {1,2}, {1,2}, 0};
    ...
    temp_wpn = {10, 50, 0, 0, 0, 11, 20, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {11, 50, 0, 0, 0, 9, 20, {1,2}, {1,2}, 1};
    ...
    temp_wpn = {6, 65, 0, 0, 0, 5, 28, {1,2}, {1,2}, 1};
