...
void Game::baseWeapons(){
    ...
    temp_wpn = {9, 60, 0, 0, 0, 9, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {11, 60, 0, 0, 0, 10, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {4, 70, 0, 0, 10, 6, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {1, 50, 0, 0, 0, 1, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {14, 90, 10, 0, 0, 7, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {16, 100, 0, 0, 10, 9, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {13, 90, 10, 0, 0, 10, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {12, 100, 0, 0, 0, 6, {1,1}, {1}, 0};
    ...
    temp_wpn = {5, 40, 0, 0, 0, 7, {1,2}, {1,2}, 1};
    ...
    temp_wpn = {9, 40, 0, 0, 0, 1, {1,2}, {1,2}, 1};
    ...
    temp_wpn = {16, 60, 0, 0, 0, 7, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {18, 30, 0, 0, 0, 20, {1,1}, {1,2}, 0};
    ...
    temp_wpn = {8, 90, 0, 0, 0, 6, {1,2}, {1,2}, 1};
    ...
    temp_wpn = {12, 70, 0, 0, 0, 10, {1,2}, {1,2}, 0};
    ...
    temp_wpn = {16, 50, 0, 0, 0, 14, {1,1}, {1,2}, 0};
    ...
    club.setDescription("Big and wooden. For when the old weapons just aren't quite old enough.");
    temp_wpn = {1, 50, 0, 0, 0, 3, {1,1}, {1,2}, 0};
