...
Weapon_stats Weapon_Stats_Infused(const Weapon  *wpn,
                                  Infusion      *infusion) {
    IES_check_ret(wpn,      Weapon_stats_default);
    IES_check_ret(infusion, Weapon_stats_default);
...
struct Range Weapon_Range(const Weapon * const wpn) {
    IES_check_ret(wpn, Range_default);
