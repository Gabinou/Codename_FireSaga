...
Tile::Tile(const std::string in_name, const Movement_cost in_cost, short int * in_stats[4]) {
	name = in_name;
	cost_struct = in_cost;
	...
	tile_stats.dodge = *in_stats[0];
	tile_stats.Pprot = *in_stats[1];
    tile_stats.Mprot = *in_stats[2];
	tile_stats.heal = *in_stats[3];
}
Tile::Tile(const std::string in_name, const Movement_cost in_cost, short int * in_stats[3], const bool in_inside) : Tile(in_name, in_cost, in_stats){
    inside = in_inside;
}
...
std::unordered_map<short int, Tile> baseTiles(const std::vector<short int> toload) {
    ...
    short int * temp_stats[3];// dodge, def, heal
    std::unordered_map<short int, Tile> temp_tiles;
    Movement_cost temp_cost;
    for (short unsigned int i = 0; i < toload.size(); i++) {
        switch (toload[i]/10){
            case TILE::PLAIN: {
                temp_stats[0] = (short int *)0;
                temp_stats[1] = (short int *)0;
                temp_stats[2] = (short int *)0;
            ...
            case TILE::BUSH: {
                temp_stats[0] = (short int *)10;
                temp_stats[1] = (short int *)0;
                temp_stats[2] = (short int *)1;
            ...
            case TILE::HILL: {
                temp_stats[0] = (short int *)15;
                temp_stats[1] = (short int *)0;
                temp_stats[2] = (short int *)2;
            ...
            case TILE::MOUNTAIN: {
                temp_stats[0] = (short int *)25;
                temp_stats[1] = (short int *)0;
                temp_stats[2] = (short int *)3;
            ...
            case TILE::PEAK: {
                temp_stats[0] = (short int *)30;
                temp_stats[1] = (short int *)0;
                temp_stats[2] = (short int *)4;
            ...
            case TILE::PILLAR: {
                temp_stats[0] = (short int *)10;
                temp_stats[1] = (short int *)1;
                temp_stats[2] = (short int *)10;
            ...
            case TILE::THRONE: {
                temp_stats[0] = (short int *)20;
                temp_stats[1] = (short int *)2;
                temp_stats[2] = (short int *)15;
                temp_cost = {0, 0, 0, 0, 0, 1, 0, 0, 0};
...
void baseTiles() {
	...
	short int * temp_stats[3] = {0, 0, 0};// dodge, def, heal
