...
Tile::Tile(const std::string in_name, const Movement_cost in_cost, const Tile_stats in_stats, const bool in_inside) {
	name = in_name;
	cost_struct = in_cost;
    ...
    for (short unsigned int i = 0; i < toload.size(); i++) {
        switch (toload[i]/10){
            case TILE::PLAIN: {
                ...
                temp_stats = {10, 0, 1, 0};
                Tile plain("Plain", temp_cost, temp_stats, false);
            ...
            case TILE::BUSH: {
                ...
                temp_stats = {15, 0, 2, 0};
                Tile bush("Bush", temp_cost, temp_stats, false);
             ...
             case TILE::FOREST: {
                ...
                temp_stats = {15, 0, 2, 0};
                Tile forest("Forest", temp_cost, temp_stats, false);
             ...
             case TILE::THICKET: {
                ...
                temp_stats = {20, 0, 3, 0};
                Tile thicket("Thicket", temp_cost, temp_stats, false);
             ...
             case TILE::SNAG: {
                temp_cost = {0, 0, 0, 0, 0, 1, 0, 0, 0};
                temp_stats = {15, 0, 2, 0};
                Tile snag("Snag", temp_cost, temp_stats, false);
             ...
             case TILE::BRIDGE: {
                temp_cost = {1, 1, 1, 1, 1, 1, 1, 1, 1};
                temp_stats = {15, 0, 2, 0};
                Tile bridge("Bridge", temp_cost, temp_stats, false);
             ...
             case TILE::HOLE: {
                temp_cost = {1, 1, 1, 1, 1, 1, 1, 1, 1};
                temp_stats = {15, 0, 2, 0};
                Tile hole("Hole", temp_cost, temp_stats, false);
             ...
             case TILE::SEA: {
                ...
                temp_stats = {15, 0, 2, 0};
                Tile sea("Sea", temp_cost, temp_stats, false);
             ...
             case TILE::LAKE: {
                ...
                temp_stats = {15, 0, 2, 0};
                Tile lake("Lake", temp_cost, temp_stats, false);
             ...
             case TILE::RIVER: {
                ...
                temp_stats = {15, 0, 2, 0};
                Tile river("River", temp_cost, temp_stats, false);
             ...
             case TILE::WATERFALL: {
                temp_cost = {0, 0, 0, 0, 0, 1, 0, 0, 0};
                temp_stats = {15, 0, 2, 0};
                Tile waterfall("Waterfall", temp_cost, temp_stats, false);
             ...
             case TILE::CLIFF: {
                temp_cost = {0, 0, 0, 0, 0, 1, 0, 0, 0};
                temp_stats = {15, 0, 2, 0};
                Tile cliff("cliff", temp_cost, temp_stats, false);
             ...
             case TILE::HILL: {
                ...
                temp_stats = {15, 0, 2, 0};
                Tile hill("hill", temp_cost, temp_stats, false);
             ...
             case TILE::MOUNTAIN: {
                ...
                temp_stats = {25, 0, 3, 0};
                Tile mountain("mountain", temp_cost, temp_stats, false);
             ...
             case TILE::PEAK: {
                ...
                temp_stats = {30, 0, 4, 0};
                Tile peak("Peak", temp_cost, temp_stats, false);
             ...
             case TILE::CAVE: {
                temp_cost = {4, 3, 4, 0, 4, 1, 0, 3, 3};
                temp_stats = {20, 0, 2, 0};
                Tile cave("Cave", temp_cost, temp_stats, false);
             ...
             case TILE::SAND: {
                ...
                temp_stats = {0, 0, 0, 0};
                Tile sand("Sand", temp_cost, temp_stats, false);
            ...
            case TILE::WASTELAND: {
                temp_cost = {3, 2, 1, 4, 3, 1, 3, 2, 2};
                temp_stats = {0, 0, 0, 0};
                Tile wasteland("Wasteland", temp_cost, temp_stats, false);
            ...
            case TILE::ROCK: {
                ...
                temp_stats = {5, 0, 2, 0};
                Tile rock("Rock", temp_cost, temp_stats, false);
            ...
            case TILE::BONES: {
                temp_cost = {0, 0, 0, 0, 0, 1, 0, 0, 0};
                temp_stats = {0, 0, 0, 0};
                Tile bones("Bones", temp_cost, temp_stats, false);
            ...
            case TILE::FLOOR: {
                temp_cost = {1, 1, 1, 1, 1, 1, 1, 1, 1};
                temp_stats = {0, 0, 0, 0};
                Tile floor("Floor", temp_cost, temp_stats, true);
            ...
            case TILE::PILLAR: {
                ...
                Tile pillar("Pillar", temp_cost, temp_stats, true);
            ...
            case TILE::WALL: {
                temp_cost = {0, 0, 0, 0, 0, 1, 0, 0, 0};
                temp_stats = {0, 0, 0, 0};
                Tile wall("Wall", temp_cost, temp_stats, true);
            ...
            case TILE::DOOR: {
                temp_cost = {0, 0, 0, 0, 0, 1, 0, 0, 0};
                temp_stats = {0, 0, 0, 0};
                Tile door("Door", temp_cost, temp_stats, true);
            ...
            case TILE::THRONE: {
                ...
                Tile throne("Throne", temp_cost, temp_stats, true);
            ...
            case TILE::GATE: {
                temp_cost = {0, 0, 0, 0, 0, 1, 0, 0, 0};
                temp_stats = {10, 1, 10, 0};
                Tile gate("Gate", temp_cost, temp_stats, false);
            ...
            case TILE::FENCE: {
                temp_cost = {0, 0, 0, 0, 0, 1, 0, 0, 0};
                temp_stats = {0, 0, 0, 0};
                Tile fence("Fence", temp_cost, temp_stats, false);
            ...
            case TILE::SHOP: {
                temp_cost = {1, 1, 1, 1, 1, 1, 1, 1, 1};
                temp_stats = {10, 1, 10, 0};
                Tile shop("Shop", temp_cost, temp_stats, false);
            ...
            case TILE::ARMORY: {
                temp_cost = {1, 1, 1, 1, 1, 1, 1, 1, 1};
                temp_stats = {15, 0, 2, 0};
                Tile armory("Armory", temp_cost, temp_stats, false);
            ...
            case TILE::VILLAGE: {
                temp_cost = {1, 1, 1, 1, 1, 1, 1, 1, 1};
                temp_stats = {15, 0, 2, 0};
                Tile village("Village", temp_cost, temp_stats, false);
            ...
            case TILE::FORT: {
                ...
                Tile fort("Fort", temp_cost, temp_stats, false);
            ...
            case TILE::CASTLE: {
                temp_cost = {0, 0, 0, 0, 0, 1, 0, 0, 0};
                temp_stats = {0, 0, 0, 0};
                Tile castle("Castle", temp_cost, temp_stats, false);
            ...
            case TILE::SNOW: {
                ...
                temp_stats = {0, 0, 0, 0};
                Tile snow("Snow", temp_cost, temp_stats, false);
            ...
            case TILE::GLACIER: {
                ...
                temp_stats = {0, 0, 0, 0};
                Tile glacier("Glacier", temp_cost, temp_stats, false);
