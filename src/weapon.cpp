...
void baseWeapons2(){
    ...
    temp_wpn = Weapon("Wrath sword", "sword", temp_wpn);
    ...
    temp_wpn = Weapon("Fleuret", "sword", temp_wpn);
    ...
    temp_wpn = Weapon("Rapière", "sword", temp_wpn);
    temp_wpn.setEffective("Armor");
    ...
    temp_wpn = Weapon("Glaive", "sword", temp_wpn);
    ...
    temp_wpn = Weapon("Saber", "sword", temp_wpn);
    ...
    temp_wpn = Weapon("Steel sword", "sword", temp_wpn);
    ...
    temp_wpn = Weapon("Damas sword", "sword", temp_wpn);
    ...
    temp_wpn = Weapon("Merciful blade", "sword", temp_wpn);
    ...
    temp_wpn = Weapon("Broadsword", "sword", temp_wpn);
    ...
    temp_wpn = Weapon("Espadon", "sword", temp_wpn);
    ...
    temp_wpn = Weapon("Oodachi", "sword", temp_wpn);
    ...
    temp_wpn = Weapon("Uchigatana", "sword", temp_wpn);
    ...
    temp_wpn = Weapon("Exsangue", "sword", temp_wpn);
    ...
    temp_wpn = Weapon("Hauteclaire", "sword", temp_wpn);
    ...
    temp_wpn = Weapon("Secundus", "sword", temp_wpn);
    ...
    temp_wpn = Weapon("Excalibur", "sword", temp_wpn);
    ...
    temp_wpn = Weapon("Galatine", "sword", temp_wpn);
    temp_wpn.setEffective("Armor");
    ...
    temp_wpn = Weapon("Raijintou", "sword", temp_wpn);
    ...
    temp_wpn = Weapon("Fuujintou", "sword", temp_wpn);
    ...
    temp_wpn = Weapon("Honjou Masamune", "sword", temp_wpn);
    ...
    temp_wpn = Weapon("Raw Iron slab", "sword", temp_wpn); //Should be found inside a dragon skull? 
...
// Should have deeps chinks. This isn't the first time demons roamed the earth. Has deep holes in it. Must be repaired before being usable. Who is willing to repair it? 
    ...
    temp_wpn = Weapon("Pitchfork", "lance", temp_wpn);
    ...
    temp_wpn = Weapon("Fighthing stick", "lance", temp_wpn);
    ...
    temp_wpn = Weapon("Iron lance", "lance", temp_wpn);
    ...
    temp_wpn = Weapon("Damas lance", "lance", temp_wpn);
    ...
    temp_wpn = Weapon("Heavy spear", "lance", temp_wpn);
    temp_wpn.setEffective("Armor");
    ...
    temp_wpn = Weapon("Trident", "lance", temp_wpn);
    ...
    temp_wpn = Weapon("Pilum", "lance", temp_wpn);
    ...
    temp_wpn = Weapon("Spear", "lance", temp_wpn);
    ...
    temp_wpn = Weapon("Vel", "lance", temp_wpn);
    ...
    temp_wpn = Weapon("Gungnir", "lance", temp_wpn);
    ...
    temp_wpn = Weapon("Achilles", "lance", temp_wpn);
    ...
    temp_wpn = Weapon("Tonbokiri", "lance", temp_wpn);
    ...
    temp_wpn = Weapon("Iron axe", "axe", temp_wpn);
    ...
    temp_wpn = Weapon("Steel axe", "axe", temp_wpn);
    ...
    temp_wpn = Weapon("Damas axe", "axe", temp_wpn);
    ...
    temp_wpn = Weapon("Hoe", "axe", temp_wpn);
    ...
    temp_wpn = Weapon("Club", "axe", temp_wpn);
    ...
    temp_wpn = Weapon("Halberd", "axelance", temp_wpn);
    ...
    all_weapons2[WEAPON::] = temp_wpn;
    temp_wpn_stats = {8, 0, 40, 0, 0, 0, 9, 30, 8, {1,1}, {1,2}, 0, 1000};
    temp_wpn = Weapon("Hammer", "axe", temp_wpn);
    temp_wpn.setEffective("Armor");
    ...
    temp_wpn = Weapon("War pick", "axe", temp_wpn);
    temp_wpn.setEffective("Armor");
    ...
    temp_wpn = Weapon("Battleaxe", "axe", temp_wpn);
    ...
    temp_wpn = Weapon("Vidyu", "axe", temp_wpn);
    ...
    temp_wpn = Weapon("Hephaestus", "axe", temp_wpn);
    ...
    temp_wpn = Weapon("Adapted Crossbow", "Bow", temp_wpn);
    ...
    temp_wpn = Weapon("Repeatable Crossbow", "Bow", temp_wpn);
    ...
    temp_wpn = Weapon("Crossbow", "Bow", temp_wpn);
    ...
    temp_wpn = Weapon("Short bow", "Bow", temp_wpn);
    ...
    temp_wpn = Weapon("Long bow", "Bow", temp_wpn);
    ...
    temp_wpn = Weapon("Composite bow", "Bow", temp_wpn);
    ...
    temp_wpn = Weapon("Recurve Crossbow", "Bow", temp_wpn);
    ...
    temp_wpn = Weapon("Recurve bow", "Bow", temp_wpn);
    ...
    temp_wpn = Weapon("Apollo", "Bow", temp_wpn);
    ...
    temp_wpn = Weapon("Artemis", "Bow", temp_wpn);
    ...
    temp_wpn = Weapon("Pinaka", "Bow", temp_wpn);
    ...
    temp_wpn = Weapon("Adapted Shield", "shield", temp_wpn);
    ...
    temp_wpn = Weapon("Pot lid", "shield", temp_wpn);
    ...
    temp_wpn = Weapon("Wooden Shield", "shield", temp_wpn);
    ...
    temp_wpn = Weapon("Cloak", "shield", temp_wpn);
    ...
    temp_wpn = Weapon("Leather Shield", "shield", temp_wpn);
    ...
    temp_wpn = Weapon("Kite Shield", "shield", temp_wpn);
    ...
    temp_wpn = Weapon("Iron Buckler", "shield", temp_wpn);
    ...
    temp_wpn = Weapon("Steel Buckler", "shield", temp_wpn);
    ...
    temp_wpn = Weapon("Spiked Buckler", "shield", temp_wpn);
    ...
    temp_wpn = Weapon("Scutum", "shield", temp_wpn);
    ...
    temp_wpn = Weapon("Master Shield", "shield", temp_wpn);
    ...
    temp_wpn = Weapon("Goddess's Hand", "shield", temp_wpn);
    ...
    temp_wpn_stats = {15, 0, 0, 10, 0, 2, 13, 19, 12, {1,1}, {1}, 0, 1000};
    temp_wpn = Weapon("Obsidian plate", "shield", temp_wpn);
    ...
    temp_wpn_stats = {15, 0, 0, 10, 0, 2, 13, 19, 12, {1,1}, {1}, 0, 1000};
    temp_wpn = Weapon("Marble plate shield", "shield", temp_wpn);
    ...
    temp_wpn_stats = {15, 0, 0, 10, 0, 2, 13, 19, 12, {1,1}, {1}, 0, 1000};
    temp_wpn = Weapon("Divine Protector", "shield", temp_wpn);
    ...
    temp_wpn = Weapon("Wristblade", "offhand", temp_wpn);
    ...
    temp_wpn_stats = {2, 0, 10, 0, 10, 0, 5, 21, 16, {1,1}, {1}, 0, 1000};
    temp_wpn = Weapon("Shield Hook", "offhand", temp_wpn);
    ...
    all_weapons2[WEAPON::SHIELD_HOOKO] = temp_wpn;
    temp_wpn_stats = {4, 0, 8, 0, 14, 0, 7, 16, 19, {1,1}, {1}, 0, 1000};
    temp_wpn = Weapon("Retractable Wristblade", "offhand", temp_wpn);
    ...
    temp_wpn = Weapon("Main Gauche", "offhand", temp_wpn);
    ...
    temp_wpn = Weapon("Swordbreaker", "offhand", temp_wpn);
    ...
    temp_wpn = Weapon("Trident Dagger", "offhand", temp_wpn);
    ...
    temp_wpn = Weapon("Dague", "offhand", temp_wpn);
    ...
    temp_wpn = Weapon("Wakizashi", "offhand", temp_wpn);
    ...
    temp_wpn = Weapon("Baquemard", "offhand", temp_wpn);
    ...
    temp_wpn = Weapon("Misericorde", "offhand", temp_wpn);
    ...
    temp_wpn = Weapon("Carnwennan", "offhand", temp_wpn);
    ...
    temp_wpn_stats = {7, 0, 0, 0, 0, 0, 7, 8, 5, {1,1}, {1}, 0, 1000};
    temp_wpn = Weapon("Void fragment", "trinket", temp_wpn);
    temp_wpn.setDescription("");
    all_weapons2[WEAPON::VOIDD] = temp_wpn;
    temp_wpn_stats = {7, 0, 0, 0, 0, 0, 7, 8, 5, {1,1}, {1}, 0, 1000};
    temp_wpn = Weapon("Demon fang", "trinket", temp_wpn);
    temp_wpn.setDescription("Ripped from the mouth of a dead demon.");
    all_weapons2[WEAPON::DEMON_FANG] = temp_wpn;
    temp_wpn_stats = {7, 0, 0, 0, 0, 0, 7, 8, 5, {1,1}, {1}, 0, 1000};
    temp_wpn = Weapon("Angel feather", "trinket", temp_wpn);
    ...
    temp_wpn_stats = {7, 0, 0, 0, 0, 0, 7, 8, 5, {1,1}, {1}, 0, 1000};
    temp_wpn = Weapon("Angel hair", "trinket", temp_wpn);
    ...
    temp_wpn_stats = {7, 0, 0, 0, 0, 0, 7, 8, 5, {1,1}, {1}, 0, 1000};
    temp_wpn = Weapon("Vial of light", "trinket", temp_wpn);
    ...
    temp_wpn = Weapon("Ball lightning", "elemental", temp_wpn);
    ...
    temp_wpn = Weapon("Icicle", "elemental", temp_wpn);
    ...
    temp_wpn = Weapon("Volcano", "elemental", temp_wpn);
    ...
    temp_wpn = Weapon("wind_spear", "elemental", temp_wpn);
    ...
    temp_wpn = Weapon("Ember", "elemental", temp_wpn);
    ...
    temp_wpn = Weapon("Tsunami", "elemental", temp_wpn);
    temp_wpn.setDescription("");
    all_weapons2[WEAPON::TSUNAMI] = temp_wpn;
    temp_wpn_stats = {0, 18, 50, 0, 0, 0, 11, 15, 7, {1,2}, {1,2}, 1, 1000};
    temp_wpn = Weapon("The God Forge's Fire", "elemental", temp_wpn);
    ...
    temp_wpn = Weapon("Fingolfin", "elemental", temp_wpn);
    ...
    temp_wpn = Weapon("Mithrandir", "elemental", temp_wpn);
    ...
    temp_wpn = Weapon("Void", "demonic", temp_wpn);
    temp_wpn.setDescription("");
    all_weapons2[WEAPON::VOIDD] = temp_wpn;
    temp_wpn_stats = {0, 5, 70, 0, 0, 0, 5, 60, 7, {1,2}, {1,2}, 1, 1000};
    temp_wpn = Weapon("Nether", "demonic", temp_wpn);
    temp_wpn.setDescription("");
    all_weapons2[WEAPON::NETHER] = temp_wpn;
    temp_wpn_stats = {0, 5, 70, 0, 0, 0, 5, 60, 7, {1,2}, {1,2}, 1, 1000};
    temp_wpn = Weapon("Downfall", "demonic", temp_wpn);
    temp_wpn.setDescription("");
    all_weapons2[WEAPON::DOWNFALL] = temp_wpn;
    temp_wpn_stats = {0, 5, 70, 0, 0, 0, 5, 60, 7, {1,2}, {1,2}, 1, 1000};
    temp_wpn = Weapon("Consume", "demonic", temp_wpn);
    temp_wpn.setDescription("");
    all_weapons2[WEAPON::CONSUME] = temp_wpn;
    temp_wpn_stats = {0, 5, 70, 0, 0, 0, 5, 60, 7, {1,2}, {1,2}, 1, 1000};
    temp_wpn = Weapon("Putrify", "demonic", temp_wpn);
    temp_wpn.setDescription("Brings out the inner rot.");
    all_weapons2[WEAPON::PUTRIFY] = temp_wpn;
    temp_wpn_stats = {0, 5, 70, 0, 0, 0, 5, 60, 7, {1,2}, {1,2}, 1, 1000};
    temp_wpn = Weapon("Glaurung", "demonic", temp_wpn);
    temp_wpn.setDescription("");
    all_weapons2[WEAPON::CLAURUNG] = temp_wpn;
    temp_wpn_stats = {0, 5, 70, 0, 0, 0, 5, 60, 7, {1,2}, {1,2}, 1, 1000};
    temp_wpn = Weapon("Morgoth", "demonic", temp_wpn);
