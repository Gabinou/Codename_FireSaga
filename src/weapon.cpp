...
void baseWeapons2(){
    ...
    temp_wpn = Weapon("Wooden sword", WPN_TYPE::SWORD, temp_wpn_stats);
    ...
    temp_wpn = Weapon("Kitchen knife", WPN_TYPE::SWORD, temp_wpn_stats);
    ...
    temp_wpn = Weapon("Wrath sword", WPN_TYPE::SWORD, temp_wpn_stats);
    temp_wpn.setDescription("Increases critical hit chance.");
    all_weapons2[WEAPON::WRATH_SWORD] = temp_wpn;
    temp_wpn_stats = {4, 0, 90, 0, 0, 0, 4, 20, 6, {1,1}, {1}, 0, 1000};
    temp_wpn = Weapon("Fleuret", WPN_TYPE::SWORD, temp_wpn_stats);
    ...
    all_weapons2[WEAPON::RAW_IRON_SLAB] = temp_wpn;
// Should have deeps chinks. This isn't the first time demons roamed the earth. Has deep holes in it. Must be repaired before being usable. Who is willing to repair it? 
    ...
    all_weapons2[WEAPON::HALBERD] = temp_wpn;
    temp_wpn_stats = {8, 0, 40, 0, 0, 0, 9, 30, 8, {1,1}, {1,2}, 0, 1000};
    temp_wpn = Weapon("Hammer", WPN_TYPE::AXE, temp_wpn_stats);
    temp_wpn.setEffective("Armor");
    ...
    temp_wpn = Weapon("War pick", WPN_TYPE::AXE, temp_wpn_stats);
    temp_wpn.setEffective("Armor");
    temp_wpn.setDescription("In trained hands, the pick can penatrate armor.");
    all_weapons2[WEAPON::WAR_PICK] = temp_wpn;
    temp_wpn_stats = {15, 0, 45, 0, 0, 0, 14, 30, 14, {1,1}, {1,2}, 0, 1000};
    temp_wpn = Weapon("Battleaxe", WPN_TYPE::AXE, temp_wpn_stats);
    temp_wpn.setDescription("Double-bladed, comically oversized axe.");
    all_weapons2[WEAPON::BATTLEAXE] = temp_wpn;
    temp_wpn_stats = {17, 0, 60, 0, 0, 0, 17, 20, 17, {1,1}, {1,2}, 0, 1000};
    temp_wpn = Weapon("Vidyu", WPN_TYPE::AXE, temp_wpn_stats);
    temp_wpn.setDescription("BattleAXE of the gods of the east.");
    all_weapons2[WEAPON::VIDYU] = temp_wpn;
    temp_wpn_stats = {19, 0, 70, 0, 0, 0, 5, 60, 20, {1,1}, {1,2}, 0, 1000};
    temp_wpn = Weapon("Hephaestus", WPN_TYPE::AXE, temp_wpn_stats);
    temp_wpn.setDescription("The god's hammer. Used to forge Secundus, the first sword.");
    all_weapons2[WEAPON::HEPHAESTUS] = temp_wpn;

    temp_wpn_stats = {12, 0, 70, 0, 0, 0, 14, 35, 9, {1,1}, {1}, 0, 1000};
    temp_wpn = Weapon("Adapted Crossbow", WPN_TYPE::BOW, temp_wpn_stats);
    temp_wpn.setDescription("Crossbow adapted to be fired, reloaded and drawn using one hand and one stump. 1H assassin only.");
    all_weapons2[WEAPON::ADAPTED_CROSSBOW] = temp_wpn;
    ...
    all_weapons2[WEAPON::REPEATABLE_CROSSBOW] = temp_wpn;
    ...
    all_weapons2[WEAPON::CROSSBOW] = temp_wpn;
    ...
    all_weapons2[WEAPON::SHORT_BOW] = temp_wpn;
    ...
    all_weapons2[WEAPON::LONG_BOW] = temp_wpn;
    ...
    all_weapons2[WEAPON::COMPOSITE_BOW] = temp_wpn;
    ...
    all_weapons2[WEAPON::RECURVE_CROSSBOW] = temp_wpn;
    ...
    all_weapons2[WEAPON::RECURVE_BOW] = temp_wpn;
    ...
    all_weapons2[WEAPON::APOLLO] = temp_wpn;
    ...
    all_weapons2[WEAPON::ARTEMIS] = temp_wpn;
    ...
    all_weapons2[WEAPON::PINAKA] = temp_wpn;
    ...
    all_weapons2[WEAPON::ADAPTED_SHIELD] = temp_wpn;
    ...
    all_weapons2[WEAPON::POT_LID] = temp_wpn;
    ...
    all_weapons2[WEAPON::WOODEN_SHIELD] = temp_wpn;
    ...
    all_weapons2[WEAPON::CLOAK] = temp_wpn;
    ...
    all_weapons2[WEAPON::LEATHER_SHIELD] = temp_wpn;
    ...
    all_weapons2[WEAPON::KITE_SHIELD] = temp_wpn;
    ...
    all_weapons2[WEAPON::IRON_BUCKLER] = temp_wpn;
    ...
    all_weapons2[WEAPON::STEEL_BUCKLER] = temp_wpn;
    ...
    all_weapons2[WEAPON::SPIKED_BUCKLER] = temp_wpn;
    ...
    all_weapons2[WEAPON::SCUTUM] = temp_wpn;
    ...
    all_weapons2[WEAPON::MASTER_SHIELD] = temp_wpn;
    ...
    all_weapons2[WEAPON::GODDESS_HAND] = temp_wpn;
    ...
    all_weapons2[WEAPON::ANCILE] = temp_wpn;
    temp_wpn_stats = {15, 0, 0, 10, 0, 2, 13, 19, 12, {1,1}, {1}, 0, 1000};
    ...
    all_weapons2[WEAPON::ROCK_PLATE] = temp_wpn;
    temp_wpn_stats = {15, 0, 0, 10, 0, 2, 13, 19, 12, {1,1}, {1}, 0, 1000};
    ...
    all_weapons2[WEAPON::OBSIDIAN_PLATE] = temp_wpn;
    temp_wpn_stats = {15, 0, 0, 10, 0, 2, 13, 19, 12, {1,1}, {1}, 0, 1000};
    ...
    all_weapons2[WEAPON::MARBLE_PLATE_SHIELD] = temp_wpn;
    temp_wpn_stats = {15, 0, 0, 10, 0, 2, 13, 19, 12, {1,1}, {1}, 0, 1000};
    ...
    all_weapons2[WEAPON::DIVINE_PROTECTOR] = temp_wpn;
    ...
    all_weapons2[WEAPON::WRISTBLADE] = temp_wpn;
    temp_wpn_stats = {2, 0, 10, 0, 10, 0, 5, 21, 16, {1,1}, {1}, 0, 1000};
    ...
    all_weapons2[WEAPON::SHIELD_HOOK] = temp_wpn;
    ...
    all_weapons2[WEAPON::RETRACTABLE_WRISTBLADE] = temp_wpn;
    ...
    all_weapons2[WEAPON::MAIN_GAUCHE] = temp_wpn;
    ...
    all_weapons2[WEAPON::SWORDBREAKER] = temp_wpn;
    ...
    all_weapons2[WEAPON::TRIDENT_DAGGER] = temp_wpn;
    ...
    all_weapons2[WEAPON::TANTOU] = temp_wpn;
    ...
    all_weapons2[WEAPON::KODACHI] = temp_wpn;
    ...
    all_weapons2[WEAPON::DAGUE] = temp_wpn;
    ...
    all_weapons2[WEAPON::WAKIZASHI] = temp_wpn;
    ...
    all_weapons2[WEAPON::BRAQUEMARD] = temp_wpn;
    ...
    all_weapons2[WEAPON::MISERICORDE] = temp_wpn;
    ...
    all_weapons2[WEAPON::CARNWENNAN] = temp_wpn;
    ...
    all_weapons2[WEAPON::FLINTLOCK] = temp_wpn;
    ...
    all_weapons2[WEAPON::SHRUNKEN_HEAD] = temp_wpn;
    temp_wpn_stats = {7, 0, 0, 0, 0, 0, 7, 8, 5, {1,1}, {1}, 0, 1000};
    temp_wpn = Weapon("Crystal", WPN_TYPE::TRINKET, temp_wpn_stats);
    temp_wpn.setDescription("");
    all_weapons2[WEAPON::CRYSTAL] = temp_wpn;
    temp_wpn_stats = {7, 0, 0, 0, 0, 0, 7, 8, 5, {1,1}, {1}, 0, 1000};
    ...
    all_weapons2[WEAPON::ANGEL_FEATHER] = temp_wpn;
    temp_wpn_stats = {7, 0, 0, 0, 0, 0, 7, 8, 5, {1,1}, {1}, 0, 1000};
    temp_wpn = Weapon("Angel hair", WPN_TYPE::TRINKET, temp_wpn_stats);
    temp_wpn.setDescription("Beautiful and fluffy. Given by incarnates and possessed to the worthy. Increases magical ability. Unusable by demons and demon incarnates.");
    all_weapons2[WEAPON::ANGEL_HAIR] = temp_wpn;    
    temp_wpn_stats = {7, 0, 0, 0, 0, 0, 7, 8, 5, {1,1}, {1}, 0, 1000};
    temp_wpn = Weapon("Angel feather", WPN_TYPE::TRINKET, temp_wpn_stats);
    temp_wpn.setDescription("Beautiful and fluffy. Given by incarnates and possessed to the worthy. Increases magical ability. Unusable by demons and demon incarnates.");
    all_weapons2[WEAPON::ANGEL_FEATHER] = temp_wpn;
    ...
    all_weapons2[WEAPON::WAR_HORN] = temp_wpn;
    ...
    all_weapons2[WEAPON::BALL_LIGHTNING] = temp_wpn;
    ...
    all_weapons2[WEAPON::ICICLE] = temp_wpn;
    ...
    all_weapons2[WEAPON::VOLCANO] = temp_wpn;
    ...
    all_weapons2[WEAPON::WIND_SPEAR] = temp_wpn;
    ...
    all_weapons2[WEAPON::GOD_FORGE_FIRE] = temp_wpn;
    ...
    temp_wpn.setEffective("Demon");
    all_weapons2[WEAPON::FINGOLFIN] = temp_wpn;
    ...
    all_weapons2[WEAPON::MITHRANDIR] = temp_wpn;
