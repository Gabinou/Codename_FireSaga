...
void test_Equation_simple() {
    ...
    nourstest_true(nmath_inbounds_int32_t( 1, 0, 23) == 1);
    nourstest_true(nmath_inbounds_int32_t(-1, 0, 23) == 0);
    nourstest_true(nmath_inbounds_int32_t(24, 0, 23) == 23);
    nourstest_true(nmath_inbounds_int32_t( 1, 0, 23) == 1);
    nourstest_true(nmath_inbounds_int32_t( 2, 0, 23) == 2);
    nourstest_true(nmath_inbounds_int32_t( 3, 0, 23) == 3);
    nourstest_true(nmath_inbounds_int32_t( 4, 0, 23) == 4);
    nourstest_true(nmath_inbounds_int32_t( 5, 0, 23) == 5);
    nourstest_true(nmath_inbounds_int32_t( 6, 0, 23) == 6);
    nourstest_true(nmath_inbounds_int32_t( 7, 0, 23) == 7);
    nourstest_true(nmath_inbounds_int32_t( 8, 0, 23) == 8);
    nourstest_true(nmath_inbounds_int32_t( 9, 0, 23) == 9);
    nourstest_true(nmath_inbounds_int32_t( 0, 0, 23) == 0);
    nourstest_true(nmath_inbounds_int32_t(23, 0, 23) == 23);
