...
void test_utilities() {
    ...
    size_t index;
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_ERWIN);
    nourstest_true(strcmp(global_unitNames[index], "Erwin") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_KIARA);
    nourstest_true(strcmp(global_unitNames[index], "Kiara") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_SILOU);
    nourstest_true(strcmp(global_unitNames[index], "Silou") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_PIROU);
    nourstest_true(strcmp(global_unitNames[index], "Pirou") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_SERVIL);
    nourstest_true(strcmp(global_unitNames[index], "Servil") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_PERIGNON);
    nourstest_true(strcmp(global_unitNames[index], "Perignon") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_LAUZON);
    nourstest_true(strcmp(global_unitNames[index], "Lauzon") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_NICOLE);
    nourstest_true(strcmp(global_unitNames[index], "Nicole") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_OTTO);
    nourstest_true(strcmp(global_unitNames[index], "Otto") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_SEBASTIAN);
    nourstest_true(strcmp(global_unitNames[index], "Sebastian") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_MICHAEL);
    nourstest_true(strcmp(global_unitNames[index], "Michael") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_CHASSE);
    nourstest_true(strcmp(global_unitNames[index], "Chasse") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_PIERRE);
    nourstest_true(strcmp(global_unitNames[index], "Pierre") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_MELLY);
    nourstest_true(strcmp(global_unitNames[index], "Melly") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_SIMON);
    nourstest_true(strcmp(global_unitNames[index], "Simon") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_RAYAN);
    nourstest_true(strcmp(global_unitNames[index], "Rayan") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_TEHARON);
    nourstest_true(strcmp(global_unitNames[index], "Teharon") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_KAKWI);
    nourstest_true(strcmp(global_unitNames[index], "Kakwi") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_EUGENE);
    nourstest_true(strcmp(global_unitNames[index], "Eugene") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_LUCRECE);
    nourstest_true(strcmp(global_unitNames[index], "Lucrece") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_ZINEDAN);
    nourstest_true(strcmp(global_unitNames[index], "Zinedan") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_ZIDINE);
    nourstest_true(strcmp(global_unitNames[index], "Zidine") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_SAWISK);
    nourstest_true(strcmp(global_unitNames[index], "Sawisk") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_BANDIT);
    nourstest_true(strcmp(global_unitNames[index], "Bandit") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_DUELIST);
    nourstest_true(strcmp(global_unitNames[index], "Duelist") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_PICKPOCKET);
    nourstest_true(strcmp(global_unitNames[index], "Pickpocket") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_THIEF);
    nourstest_true(strcmp(global_unitNames[index], "Thief") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_ARCHER);
    nourstest_true(strcmp(global_unitNames[index], "Archer") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_MARKSMAN);
    nourstest_true(strcmp(global_unitNames[index], "Marksman") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_CORSAIR);
    nourstest_true(strcmp(global_unitNames[index], "Corsair") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_VIKING);
    nourstest_true(strcmp(global_unitNames[index], "Viking") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_RAVAGER);
    nourstest_true(strcmp(global_unitNames[index], "Ravager") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_HOPLITE);
    nourstest_true(strcmp(global_unitNames[index], "Hoplite") == 0);
    index = *(uf16 *)DTAB_GET(global_unitOrders, UNIT_ID_FENCER);
