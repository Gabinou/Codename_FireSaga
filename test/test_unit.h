...
void test_canEquip() {
    ...
    Unit_InitWweapons(&equiper, weapons_dtab);
    Unit_setClassind(&equiper, UNIT_CLASS_FENCER);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_FLEURET)        == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_MAIN_GAUCHE)    == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_PITCHFORK)      == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_HOE)            == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_SHORT_BOW)      == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_ADAPTED_SHIELD) == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_POT_LID)        == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_ICICLE)         == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_NETHER)         == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_MOONLIGHT)      == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_HEAL)           == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_CLAW)           == 0);

    Unit_setClassind(&equiper, UNIT_CLASS_DUKE);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_FLEURET)        == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_MAIN_GAUCHE)    == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_PITCHFORK)      == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_HOE)            == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_SHORT_BOW)      == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_ADAPTED_SHIELD) == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_POT_LID)        == 1);
    ...
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_FLEURET)        == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_MAIN_GAUCHE)    == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_PITCHFORK)      == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_HOE)            == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_SHORT_BOW)      == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_ADAPTED_SHIELD) == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_POT_LID)        == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_ICICLE)         == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_NETHER)         == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_MOONLIGHT)      == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_HEAL)           == 0);
    ...
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_ICICLE)         == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_NETHER)         == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_MOONLIGHT)      == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_HEAL)           == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_RADIANT_CLAW)   == 1);

    Unit_setClassind(&equiper, UNIT_CLASS_DEMON);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_FLEURET)        == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_MAIN_GAUCHE)    == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_PITCHFORK)      == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_HOE)            == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_SHORT_BOW)      == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_ADAPTED_SHIELD) == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_POT_LID)        == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_ICICLE)         == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_NETHER)         == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_MOONLIGHT)      == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_HEAL)           == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_CLAW)           == 1);
    ...
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_MAIN_GAUCHE)    == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_PITCHFORK)      == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_IRON_AXE)       == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_SHORT_BOW)      == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_ADAPTED_SHIELD) == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_POT_LID)        == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_ICICLE)         == 0);
    ...
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_MAIN_GAUCHE)    == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_PITCHFORK)      == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_STEEL_AXE)      == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_SHORT_BOW)      == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_ADAPTED_SHIELD) == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_POT_LID)        == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_ICICLE)         == 0);
    ...
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_MAIN_GAUCHE)    == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_PITCHFORK)      == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_DAMAS_AXE)      == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_SHORT_BOW)      == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_ADAPTED_SHIELD) == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_POT_LID)        == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_ICICLE)         == 0);
    ...
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_FLEURET)        == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_MAIN_GAUCHE)    == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_IRON_LANCE)     == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_HOE)            == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_SHORT_BOW)      == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_ADAPTED_SHIELD) == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_POT_LID)        == 1);
    ...
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_ADAPTED_SHIELD) == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_POT_LID)        == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_ICICLE)         == 1);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_NETHER)         == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_MOONLIGHT)      == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_HEAL)           == 0);
    nourstest_true(Unit_canEquip_Type(&equiper, ITEM_ID_CLAW)           == 0);
